  ...
  return (
    <>
        ...
        <div className="foots ml-16 mt-11 ">
          <div className="footer-left mb-5">
            <h1>
              ...
              <span className="text-blue-300 text-2xl font-bold font-serif">
                Harbor
              </span>
            </h1>
        ...
        <div className="foots foot-r mt-11 mr-20 ">
          ...
          <div className="footer-r footer-right ml-40">
            ...
            <p className="mt-2">
              ...
              <span className=" font-bold relative bottom-1 left-2 right-3">
                Address:
              </span>{" "}
              <span className=" font-semibold relative bottom-1 left-2">
                Jawalakhel,Lalitpur
              </span>{" "}
            </p>
            <p className="mt-2">
      ...
      <div className="foot-div">
        <p className="foot-para justify-center text-center mt-4 mb-4 text-white font-semibold">
          Copyright 2023 design and developed by Aman Singh & Asmita Shrestha
        </p>
      </div>
    </>
  );
